    ...
    <>
      <nav className="navbar nav-class sticky top-0 navbar-expand-lg itemms ">
        <div className="container d-flex">
          ...
          {/* <button onClick={drawerOpen} className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      >
        ...
        <ul>
            <li className='nav-link'>
              <Link to="/" className='text-decoration-none text-black fs-4'>Home</Link>
            </li>
            <li className='nav-link'>
              <Link to="/home1" className='text-decoration-none text-black fs-5 mx-4'>Home 01</Link>
            </li>
            <li className='nav-link'>
              <Link to="/home2" className='text-decoration-none text-black fs-5 mx-4'>Home 02</Link>
            </li>
            <li className='nav-link'>
              <Link to="/about" className='text-decoration-none text-black fs-4'>About</Link>
            </li>
            <li className='nav-link'>
              <Link to="/service" className='text-decoration-none text-black fs-4'>Service</Link>
            </li>
            <li className='nav-link'>
              <Link to="/team" className='text-decoration-none text-black fs-4'>Team</Link>
            </li>
            <li className='nav-link'>
              <Link to="/blog" className='text-decoration-none text-black fs-4'>Blog</Link>
            </li>
            <li className='nav-link'>
              <Link to="/blogleftsidebar" className='text-decoration-none text-black fs-5 mx-4'>Blog Grid Left Sidebar</Link>
            </li>
            <li className='nav-link'>
              <Link to="/blogrightsidebar" className='text-decoration-none text-black fs-5 mx-4'>Blog Grid Right Sidebad</Link>
            </li>
            <li className='nav-link'>
              <Link to="/blogwithoutsidebar" className='text-decoration-none text-black fs-5 mx-4'>Blog Grid Without Sidebar</Link>
            </li>
            <li className='nav-link'>
              <Link to="/bloglsidebar" className='text-decoration-none text-black fs-5 mx-4'>Blog List Left Sidebar</Link>
            </li>
            <li className='nav-link'>
